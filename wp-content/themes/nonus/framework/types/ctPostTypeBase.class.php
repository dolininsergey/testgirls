...
class ctPostTypeBase extends ctTypeBase {
	...
	<?php if ($supportsRevolutionSlider): ?>
        <p class="ct-toggable revolution-slider display">
            ...
            <select id="revolutionSlider" name="revolution_slider">
                ...
                <option <?php echo selected($slide->alias, $revolution_slider)?> value="<?php echo esc_attr($slide->alias)?>"><?php echo esc_html($slide->title)?></option>
				<?php endforeach;?>
            </select>
        </p>
    ...
    <p>
        ...
        <textarea id="quote" class="regular-text" name="quote" cols="100" rows="10"><?php echo esc_html($quote); ?></textarea>
    </p>
    <p class="howto"><?php _e("Quote content", 'ct_theme')?></p>

    <p>
        <label for="quoteAuthor"><?php _e('Author', 'ct_theme')?>: </label>
        <input id="quoteAuthor" class="regular-text" name="quoteAuthor" value="<?php echo esc_attr($quoteAuthor); ?>">
    </p>
	...
	<p>
        ...
        <input type="text" id="videoM4V" class="regular-text" name="videoM4V" value="<?php echo esc_url($videoM4V); ?>"/>
    </p>
    <p class="howto"><?php _e("The URL to the .m4v video file", 'ct_theme')?></p>
	<p>
        <label for="videoOGV"><?php _e('OGV File URL', 'ct_theme')?>: </label>
        <input type="text" id="videoOGV" class="regular-text" name="videoOGV" value="<?php echo esc_url($videoOGV); ?>"/>
    </p>
    ...
    <p>
        ...
        <input type="text" id="videoDirect" class="regular-text" name="videoDirect" value="<?php echo esc_url($videoDirect); ?>"/>
    </p>
    ...
    <p>
        ...
        <input type="text" id="audioMP3" class="regular-text" name="audioMP3" value="<?php echo esc_url($audioMP3); ?>"/>
    </p>
    <p class="howto"><?php _e("The URL to the .mp3 audio file", 'ct_theme')?></p>
    <p>
        <label for="audioOGA"><?php _e('OGA File URL', 'ct_theme')?>: </label>
        <input type="text" id="audioOGA" class="regular-text" name="audioOGA" value="<?php echo esc_url($audioOGA); ?>"/>
    </p>
    <p class="howto"><?php _e("The URL to the .oga, .ogg audio file", 'ct_theme')?></p>
    <p>
        <label for="audioPoster"><?php _e('Poster URL', 'ct_theme')?>: </label>
        <input type="text" id="audioPoster" class="regular-text" name="audioPoster" value="<?php echo esc_url($audioPoster); ?>"/>
    </p>
    ...
    <p>
        ...
        <input type="text" id="audioPosterHeight" class="regular-text" name="audioPosterHeight" value="<?php echo (int)$audioPosterHeight; ?>"/>
    </p>
